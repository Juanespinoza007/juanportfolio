  ...
  return (
    ...
    >
      <div
        ...
        className="absolute bottom-1/3 left-0 px-4 p-8 max-w-[75%] text-left left-[12.5%] pl-0"
      >
        ...
        <h1 className="text-[#FFF5EA] font-semibold md:text-[4rem] xl:text-[5rem] break-words leading-tight">
          ...
          <span className="font-orbitron text-3xl sm:text-4xl md:text-[3rem]">
            Juan Espinoza
          </span>
        </h1>

        <div className="min-h-[10px] text-3xl">
          {/*
        ...
        <p className="text-[#FFF5EA] text-lg whitespace-normal break-words w-full sm:max-w-[80%] md:max-w-[60%] mt-4">
          Pioneering the space exploration and defense industry with{" "}
          <span className="text-[#CC5500] font-bold">AI</span>.
        </p>
      </div>
